/**
 * TV1 PDF Converter
 * Template - Customize the parsing logic for TV1 TC PDFs
 */
const tv1Converter = {
    channelName: 'TV1',
    ...
    async convert(file) {
        try {
            ...
            console.error('Error converting TV1 PDF:', error);
            throw new Error(`PDF conversion failed: ${error.message}`);
        }
    },

    /**
     * TODO: Customize based on TV1 PDF format
     */
    parsePage(text) {
        const records = [];
        ...
        lines.forEach(line => {
            // TODO: Add TV1 specific patterns
...
window.tv1Converter = tv1Converter;
