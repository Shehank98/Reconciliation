/**
 * ITN PDF Converter
 * Template - Customize the parsing logic for ITN TC PDFs
 */
const itvConverter = {
    channelName: 'ITN',
    ...
    async convert(file) {
        try {
            ...
            console.error('Error converting ITN PDF:', error);
            throw new Error(`PDF conversion failed: ${error.message}`);
        }
    },

    /**
     * TODO: Customize based on ITN PDF format
     */
    parsePage(text) {
        const records = [];
        ...
        lines.forEach(line => {
            // TODO: Add ITN specific patterns
...
window.itvConverter = itvConverter;
